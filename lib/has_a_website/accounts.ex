defmodule HasAWebsite.Accounts do
  @moduledoc """
  ...
  alias HasAWebsite.Accounts.{User, UserToken, UserNotifier}
  ...
  See `HasAWebsite.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `HasAWebsite.Accounts.User.password_changeset/3` for a list of supported options.
